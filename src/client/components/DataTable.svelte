<script lang="ts">
  ...
  import { Checkbox, Table as FlowbiteTable, TableBody, TableBodyCell, TableBodyRow, TableHead, TableHeadCell } from 'flowbite-svelte';
...
<FlowbiteTable class={[tableClass, 'border border-gray-400 mb-2.5 mr-2.5']} striped hoverable>
  <TableHead>
    {#if selectable}
      <TableHeadCell>
        <Checkbox
